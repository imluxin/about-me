...
;(function($) {
	...
	$.timeliner = function(options){
		...
		settings = jQuery.extend({
			...
			expandAllText: '+ 展开所有', // value: string, sets the text of the expandAll selector after the timeline is fully collapsed
			collapseAllText: '- 关闭所有' // // value: string, sets the text of the expandAll selector after the timeline is fully expanded
		}, options);
